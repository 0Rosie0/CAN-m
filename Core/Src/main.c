...
void CAN_FilterInit(FDCAN_HandleTypeDef* hcan,uint32_t can_filter_id,uint32_t can_filter_mask) {
  ...
  CAN_Filter_InitStruct.FilterIndex = 0;
  CAN_Filter_InitStruct.FilterConfig = FDCAN_FILTER_TO_RXFIFO0;
  CAN_Filter_InitStruct.FilterID1 = can_filter_id;
  CAN_Filter_InitStruct.FilterID2 = can_filter_mask;

  HAL_FDCAN_ConfigFilter(hcan,&CAN_Filter_InitStruct);
}
